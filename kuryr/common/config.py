...
raven_opts = [
    ...
    cfg.IntOpt('max_wait_interval', default=30,
               help=_('The maximum time in seconds for the wait interval of '
                      'the translations')),
    cfg.StrOpt('public_net_id', default=os.environ.get(
                    'PUBLIC_NET_ID', '39029e1e-46f8-4330-8b0f-8d88db6a8a0e')),
    cfg.StrOpt('raven_single_shot', default=os.environ.get(
                      'RAVEN_SINGLE_SHOT', False)),
